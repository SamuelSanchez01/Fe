...
const parseDiscriminator_js_1 = require("./parseDiscriminator.js");
...
const selectParser = (schema, refs) => {
    ...
    else if (exports.its.a.discriminator(schema)) {
        return (0, parseDiscriminator_js_1.parseDiscriminator)(schema, refs);
    }
...
exports.its = {
    ...
    a: {
        ...
        discriminator: (x) => x.oneOf !== undefined && x.discriminator?.propertyName !== undefined,
