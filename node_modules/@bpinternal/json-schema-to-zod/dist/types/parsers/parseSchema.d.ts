import { Refs, JsonSchemaObject, JsonSchema, Serializable, JSONSchemaExtended } from "../Types.js";
export declare const parseSchema: (schema: JSONSchemaExtended, refs?: Refs, blockMeta?: boolean) => string;
export declare const its: {
    ...
    a: {
        ...
        discriminator: (x: JsonSchemaObject) => x is {
            type?: string | string[] | undefined;
            properties?: {
                [key: string]: JsonSchema;
            } | undefined;
